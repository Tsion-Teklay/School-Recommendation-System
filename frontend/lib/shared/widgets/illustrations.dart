  ...
  Widget _getIllustrationWidget(double size, Color color) {
    switch (type) {
      ...
      case IllustrationType.education:
        return Icon(Icons.school, size: size * 0.6, color: color);
      case IllustrationType.community:
        return Icon(Icons.groups, size: size * 0.6, color: color);
      case IllustrationType.growth:
        return Icon(Icons.trending_up, size: size * 0.6, color: color);
    }
  }
}
